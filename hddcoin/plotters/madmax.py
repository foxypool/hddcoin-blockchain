...
from hddcoin.plotting.create_plots import resolve_plot_keys
from hddcoin.plotters.plotters_util import run_plotter, run_command
...
def get_madmax_executable_path_for_ksize(plotters_root_path: Path, ksize: int = 32) -> Path:
    ...
    madmax_exec: str = "hddcoin_plot"
    if ksize > 32:
        madmax_exec += "_k34"  # Use the hddcoin_plot_k34 executable for k-sizes > 32
    ...
    if is_madmax_supported():
        ...
        run_command(
            [
                "git",
                "clone",
                "https://github.com/HDDcoin-Network/hddcoin-plotter-madmax.git",
                MADMAX_PLOTTER_DIR,
            ],
...
def plot_madmax(args, hddcoin_root_path: Path, plotters_root_path: Path):
