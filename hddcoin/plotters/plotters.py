...
from hddcoin.plotters.bladebit import get_bladebit_install_info, plot_bladebit
from hddcoin.plotters.chiapos import get_chiapos_install_info, plot_hddcoin
from hddcoin.plotters.madmax import get_madmax_install_info, plot_madmax
from hddcoin.plotters.install_plotter import install_plotter
...
def call_plotters(root_path: Path, args):
    # Add `plotters` section in HDDCOIN_ROOT.
    hddcoin_root_path = root_path
    ...
    if not os.path.exists(root_path):
        print(f"Creating plotters folder within HDDCOIN_ROOT: {root_path}")
        try:
            os.mkdir(root_path)
        except Exception as e:
    ...
    build_parser(subparsers, root_path, hddcoin_plotter, "chiapos", "Chiapos Plotter")
    ...
    if args.plotter == "chiapos":
        plot_hddcoin(args, hddcoin_root_path)
    if args.plotter == "madmax":
        plot_madmax(args, hddcoin_root_path, root_path)
    if args.plotter == "bladebit":
        plot_bladebit(args, hddcoin_root_path, root_path)
