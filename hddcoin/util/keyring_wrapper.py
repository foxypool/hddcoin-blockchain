...
class KeyringWrapper:
    ...
    def set_master_passphrase(
        ...
        from hddcoin.util.keychain import KeyringCurrentPassphaseIsInvalid, KeyringRequiresMigration
    ...
    def migrate_legacy_keyring(self):
        ...
        from hddcoin.util.keychain import Keychain, MAX_KEYS
    ...
    def confirm_legacy_keyring_cleanup(self, legacy_keyring, service, users):
        ...
        # [hddcoin_2Duser_2Dhddcoin_2D1_2E8] is left behind
