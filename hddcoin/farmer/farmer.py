...
from hddcoin.farmer.pooling.constants import constants
from hddcoin.farmer.pooling.og_pool_state import OgPoolState
from hddcoin.farmer.pooling.pool_api_client import PoolApiClient
...
DEFAULT_OG_POOL_URL: str = "https://farmer.hddcoin-og.foxypool.io"
...
class Farmer:
    ...
    async def setup_keys(self):
        ...
        self.pool_target_encoded = self.pool_config["hdd_target_address"]
