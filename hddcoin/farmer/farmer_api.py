...
from hddcoin.consensus.network_type import NetworkType
...
from hddcoin.farmer.pooling.og_pool_protocol import PartialPayload, SubmitPartial
                ...
                try:
                    async with aiohttp.ClientSession() as session:
                        async with session.post(
                            ...
                            headers={"User-Agent": f"HDDcoin Blockchain v.{__version__}"},
                        ) as resp:
                            if resp.ok:
