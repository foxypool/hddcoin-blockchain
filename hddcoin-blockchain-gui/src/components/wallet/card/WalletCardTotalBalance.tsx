...
import { byte_to_hddcoin_string } from '../../../util/hddcoin';
...
export default function WalletCardTotalBalance(props: Props) {
  ...
  return (
    <FarmCard
      ...
      tooltip={
        <Trans>
          This is the total amount of hddcoin in the blockchain at the current peak
      ...
      value={
        <>
          {byte_to_hddcoin_string(value)} {currencyCode}
        </>
      }
      description={
